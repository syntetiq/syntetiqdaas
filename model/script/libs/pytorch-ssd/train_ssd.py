...
log_dir=os.path.join('models', "tensorboard", f"{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}")
parser.add_argument('--tensorboard', default=log_dir, type=str, help='Tensorboard path')
...
tensorboard = SummaryWriter(args.tensorboard)

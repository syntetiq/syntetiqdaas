...
class AddOwnershipToRemainingEntities implements Migration
{
    ...
    public function up(Schema $schema, QueryBag $queries): void
    {
        $this->addOwnership(
            ...
            'idx_sq_model_build_organization',
            'idx_sq_model_build_owner',
            'fk_sq_model_build_organization',
            'fk_sq_model_build_owner'
        );
        $this->addOwnership(
            $schema,
            'syntetiq_model_pretrained',
            'idx_sq_model_pretrained_organization',
            'idx_sq_model_pretrained_owner',
            'fk_sq_model_pretrained_organization',
            'fk_sq_model_pretrained_owner'
        );
    }
